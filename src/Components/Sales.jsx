...
<div role="presentation" >
  ...
  <Grid item xs={4}>
   ...
   {/* table */}
   <>
   <Button className='text-dark' style={{backgroundColor: "#85ddff"}} onClick={addrow}>Add row</Button>
  ...
  <Table>
    ...
    <TableHead style={{backgroundColor: "#000"}}>
      <TableRow>
        ...
        <TableCell  className='text-light'>Product Name </TableCell>
        <TableCell  className='text-light'>MRP </TableCell>
        <TableCell  className='text-light'>Price </TableCell>
        <TableCell  className='text-light'>Quantity </TableCell>
        <TableCell  className='text-light'>SubTotal </TableCell>
        <TableCell  className='text-light'>GstPercent </TableCell>
        <TableCell  className='text-light'> GstTotal </TableCell>
        <TableCell  className='text-light'>BillTotal </TableCell>
  ...
  <Box style={{float:"right"}}  className='mt-2'><Button type='submit' onClick={saledata} variant='contained' color='primary'  className='mt-2 align-items-center text-dark' style={{backgroundColor: "#85ddff"}}>Submit</Button>
